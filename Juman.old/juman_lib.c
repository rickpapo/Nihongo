...
BOOL juman_init_rc ( FILE *fp ) {
	...
	*/
	...
	/* 文法ファイル */
	num = 0 ;
	GetPrivateProfileString ( "juman", "dicfile", "C:\\PROJECTS\\Nihongo\\Juman-5.1\\dic", Jumangram_Dirname, sizeof(Jumangram_Dirname), "juman.ini" ) ;
	if ( Jumangram_Dirname[0] ) {
		...
		connect_matrix ( NULL ) ;
		/* 辞書ファイル */
		GetPrivateProfileString ( "juman", "dicfile", "C:\\PROJECTS\\Nihongo\\Juman-5.1\\dic", dic_file_name, sizeof(dic_file_name), "juman.ini" ) ;
